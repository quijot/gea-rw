...
class Profesional(models.Model):
    ...
    lugar = models.ForeignKey(Lugar, blank=True, null=True, default=None, on_delete=models.SET_NULL)
    telefono = models.CharField("teléfono", max_length=15, blank=True)
    web = models.URLField(max_length=50, blank=True)
    email = models.EmailField(max_length=50, blank=True)
    cuit_cuil = models.CharField("CUIT/CUIL", max_length=14, blank=True, null=True)
